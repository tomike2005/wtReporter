...
df[11,1] <- "F4a"
df[11,2] <- "Revenue ($Millions)"
df[11,3] <- "Month"
df[11,4] <- "$19.7"
df[11,7] <- ""

df[12,1] <- "F4b"
df[12,2] <- "Revenue ($Millions)"
df[12,3] <- "YTD"
df[12,4] <- "$39"
df[12,7] <- ""

df[13,1] <- "F5a"
df[13,2] <- "Gross Margin $"
df[13,3] <- "Month"
df[13,4] <- "$5.9"
df[13,7] <- ""
...
df[16,1] <- "F6"
df[16,2] <- "Bookings ($Millions)"
df[16,3] <- "YTD"
df[16,4] <- "$61.9"
df[16,7] <- ""

df[17,1] <- "F7"
df[17,2] <- "Backlog ($Millions)"
df[17,3] <- "Period End"
df[17,4] <- "0"
df[17,7] <- ""

df[18,1] <- "F8a"
df[18,2] <- "Cap Ex ($Millions)"
df[18,3] <- "Month"
df[18,4] <- "0"
df[18,7] <- ""

df[19,1] <- "F8b"
df[19,2] <- "Cap Ex ($Millions)"
df[19,3] <- "YTD"
df[19,4] <- "0"
df[19,7] <- ""

df[20,1] <- "F9"
df[20,2] <- "Net Bank Debt ($Millions)"
df[20,3] <- "Period End"
df[20,4] <- "0"
df[20,7] <- ""

df[21,1] <- "F10"
df[21,2] <- "RONA (NI/(FA+NWC)"
df[21,3] <- "Period End"
df[21,4] <- "0"
df[21,7] <- ""

df[22,1] <- "F11"
df[22,2] <- "Rental Unit Utilization"
df[22,3] <- "Period End"
df[22,4] <- "0"
df[22,7] <- ""
...
df[25,1] <- "P1b"
df[25,2] <- "Headcount Total"
df[25,3] <- "Period End"
df[25,4] <- "656"
df[25,7] <- ""

df[26,1] <- "P2"
df[26,2] <- "Employee Turnover Rate"
df[26,3] <- "Rolling 12 Month"
df[26,4] <- "12%"
df[26,7] <- ""

df[27,1] <- "P3"
df[27,2] <- "GM$ / Employee Total ($'000)"
df[27,3] <- "Rolling 12 Month"
df[27,4] <- "$72"
df[27,7] <- ""
